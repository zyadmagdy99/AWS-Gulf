...
function Brands() {
  const {Ison} = useTheme();
  return (
    <div className={`${Ison?"bg-white":"bg-black"}  flex h-[7rem] flex-row-reverse justify-between md:justify-center border shadow-md shadow-gray-200  `}>
      <div className='flex items-center md:w-1/2 gap-4  md:gap-0 pe-4 md:pe-0 justify-between xl:justify-around'>
